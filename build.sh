...
cp -r index.html login.html styles.css login-styles.css app.js auth.js auth-ui.js auth-styles.css cloudflare-auth.js login.js pwa.js register-sw.js sw.js manifest.json _redirects dist/
