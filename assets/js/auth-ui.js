...
// Show user profile - modified to not create floating profile
function showUserProfile(user) {
  // We no longer create a floating profile bar
  // Just update UI to show logged in state
  const authContainer = document.getElementById('auth-container');
  if (authContainer) {
    authContainer.style.display = 'none';
  }

  // Update sidebar user info instead
...
function updateSidebarUserInfo(user) {
  ...
  // Just dispatch an event that sidebar.js can listen for
